...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'compositions_composition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='compositions', to=orm['accounts.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.CharField')(default='IM', max_length=6)),
            ('display_image', self.gf('django.db.models.fields.files.ImageField')(default='/media/root/composition_image_default.jpg', max_length=100, blank=True)),
            ('matter', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'compositions', ['Composition'])


    def backwards(self, orm):
        # Deleting model 'Composition'
        db.delete_table(u'compositions_composition')
