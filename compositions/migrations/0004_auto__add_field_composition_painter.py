...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Composition.painter'
        db.add_column(u'compositions_composition', 'painter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Composition.painter'
        db.delete_column(u'compositions_composition', 'painter')
    ...
    models = {
        ...
        u'compositions.composition': {
            ...
            'painter': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
