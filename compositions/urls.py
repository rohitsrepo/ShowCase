...
urlpatterns = patterns('',
                       ...
                       url(r'^/(?P<slug>[\w-]+)$', views.CompositionDetail.as_view(), name='composition-detail'),
                       url(r'^/(?P<pk>[0-9]+)/votes', include('votes.urls')),
                       url(r'^/(?P<composition_id>[0-9]+)/associates', 'compositions.views.get_associates'),
                       ...
                       url(r'^/(?P<composition_id>[0-9]+)/interprets$',
                            'interpretations.views.get_composition_interprets'
                        ),
               )
