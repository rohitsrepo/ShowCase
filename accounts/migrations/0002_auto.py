...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field bookmarks on 'User'
        m2m_table_name = db.shorten_name(u'accounts_user_bookmarks')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'accounts.user'], null=False)),
            ('composition', models.ForeignKey(orm[u'compositions.composition'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'composition_id'])


    def backwards(self, orm):
        # Removing M2M table for field bookmarks on 'User'
        db.delete_table(db.shorten_name(u'accounts_user_bookmarks'))
    ...
    models = {
        u'accounts.user': {
            ...
            'bookmarks': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['compositions.Composition']", 'symmetrical': 'False'}),
