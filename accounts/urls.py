...
urlpatterns = patterns('',
                      ...
                      url(r'^/reset-password$', 'accounts.settingsViews.reset_password'),
                      url(r'^/reset-password-confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)$', 'accounts.settingsViews.reset_password_confirm'),
                      ...
                      url(r'^/me/buckets$', 'buckets.views.get_my_buckets'),
                      url(r'^/me/drafts$', 'accounts.views.get_my_drafts'),
