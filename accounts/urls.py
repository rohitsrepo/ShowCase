...
urlpatterns = patterns('',
                      ...
                      url(r'^/reset-nsfw$', 'accounts.views.reset_nsfw'),
                      ...
                      url(r'^/bookmarks$', userbookmarks.UserBookmarksAdd.as_view()),
                      url(r'^/bookmarks/(?P<pk>[0-9]+)$', userbookmarks.UserBookmarksDelete.as_view()),
                      url(r'^/(?P<pk>[0-9]+)/bookmarks$', userbookmarks.UserBookmarksRead.as_view()),
